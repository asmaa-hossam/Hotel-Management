    ...
    <Box pt="50px">
      ...
      <Grid container spacing={2}>
        ...
        <Typography
          ...
          {error && (
            <FormHelperText error sx={{ mt: 1, textAlign: isRTL ? "right" : "left" }}>
              {error}
            </FormHelperText>
          )}
          ...
          <Button
            sx={{
              ...
              padding: "0.5rem 5rem",
              mt: "2rem",
              ml: isRTL ? "0rem" : "0.5rem",
              mr: isRTL ? "0.5rem" : "0rem",
              fontFamily: isRTL ? "'Tajawal', sans-serif" : "'Poppins', sans-serif",
            }}
            onClick={getRooms}
            disabled={loading}
          >
            {loading ? t("searching") : t("exploreButton")}
          </Button>
        </Grid>
